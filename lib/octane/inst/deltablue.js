...
function Strength(strengthValue, name) {
    var $disclosure13 = $disclosure.create(arguments);
    this.$disclosure_index = [
        13,
        $disclosure13.$ref_index
    ];
    $disclosure13.$scopes.$disclosure13 = $disclosure13.$ref_index;
    $disclosure13.strengthValue = strengthValue;
    $disclosure13.name = name;
    this.strengthValue = $disclosure13.strengthValue;
    this.name = $disclosure13.name;
}

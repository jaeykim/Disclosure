Code.bootstrap(module, function (Σ) {
    Σ.setExtractor(function () {
        return this.capture({}, {
            RegExpSuite: RegExpSuite,
            regExpBenchmark: regExpBenchmark
        });
    }).hoist(RegExpSetup, Σ).hoist(RegExpRun, Σ).hoist(RegExpTearDown, Σ).hoist(computeInputVariants, Σ).hoist(RegExpBenchmark, Σ);
    ...
    function computeInputVariants(str, n) {
        var Σ_computeInputVariants = new Σ.Scope(this, Σ, computeInputVariants, function () {
            return this.capture({
                str: str,
                n: n
            }, { variants: variants });
    ...
    function RegExpBenchmark() {
        var Σ_RegExpBenchmark = new Σ.Scope(this, Σ, RegExpBenchmark, function () {
            return this.capture({}, {
                re0: re0,
                re1: re1,
                re2: re2,
        ...
        }).hoist(Exec, Σ_RegExpBenchmark).hoist(runBlock0, Σ_RegExpBenchmark).hoist(runBlock1, Σ_RegExpBenchmark).hoist(runBlock2, Σ_RegExpBenchmark).hoist(runBlock3, Σ_RegExpBenchmark).hoist(runBlock4, Σ_RegExpBenchmark).hoist(runBlock5, Σ_RegExpBenchmark).hoist(runBlock6, Σ_RegExpBenchmark).hoist(runBlock7, Σ_RegExpBenchmark).hoist(runBlock8, Σ_RegExpBenchmark).hoist(runBlock9, Σ_RegExpBenchmark).hoist(runBlock10, Σ_RegExpBenchmark).hoist(runBlock11, Σ_RegExpBenchmark).hoist(run, Σ_RegExpBenchmark);
        function Exec(re, string) {
            var Σ_RegExpBenchmark_Exec = new Σ.Scope(this, Σ_RegExpBenchmark, Exec, function () {
                return this.capture({
                    re: re,
                    string: string
                }, {
        ...
        function runBlock0() {
            var Σ_RegExpBenchmark_runBlock0 = new Σ.Scope(this, Σ_RegExpBenchmark, runBlock0, function () {
        ...
        function runBlock1() {
            var Σ_RegExpBenchmark_runBlock1 = new Σ.Scope(this, Σ_RegExpBenchmark, runBlock1, function () {
                return this.capture({}, { sum: sum });
            });
            var sum = 0;
            for (var i = 0; i < 78; i++) {
        ...
        function runBlock2() {
            var Σ_RegExpBenchmark_runBlock2 = new Σ.Scope(this, Σ_RegExpBenchmark, runBlock2, function () {
                return this.capture({}, { sum: sum });
            });
            var sum = 0;
            for (var i = 0; i < 40; i++) {
        ...
        function runBlock3() {
            var Σ_RegExpBenchmark_runBlock3 = new Σ.Scope(this, Σ_RegExpBenchmark, runBlock3, function () {
                return this.capture({}, { sum: sum });
            });
            var sum = 0;
            for (var i = 0; i < 23; i++) {
        ...
        function runBlock4() {
            var Σ_RegExpBenchmark_runBlock4 = new Σ.Scope(this, Σ_RegExpBenchmark, runBlock4, function () {
                return this.capture({}, { sum: sum });
            });
            var sum = 0;
            for (var i = 0; i < 16; i++) {
        ...
        function runBlock5() {
            var Σ_RegExpBenchmark_runBlock5 = new Σ.Scope(this, Σ_RegExpBenchmark, runBlock5, function () {
                return this.capture({}, { sum: sum });
            });
            var sum = 0;
            for (var i = 0; i < 13; i++) {
        ...
        function runBlock6() {
            var Σ_RegExpBenchmark_runBlock6 = new Σ.Scope(this, Σ_RegExpBenchmark, runBlock6, function () {
                return this.capture({}, { sum: sum });
            });
            var sum = 0;
            for (var i = 0; i < 11; i++) {
        ...
        function runBlock7() {
            var Σ_RegExpBenchmark_runBlock7 = new Σ.Scope(this, Σ_RegExpBenchmark, runBlock7, function () {
                return this.capture({}, { sum: sum });
            });
            var sum = 0;
            for (var i = 0; i < 9; i++) {
        ...
        function runBlock8() {
            var Σ_RegExpBenchmark_runBlock8 = new Σ.Scope(this, Σ_RegExpBenchmark, runBlock8, function () {
                return this.capture({}, { sum: sum });
            });
            var sum = 0;
            for (var i = 0; i < 7; i++) {
        ...
        function runBlock9() {
            var Σ_RegExpBenchmark_runBlock9 = new Σ.Scope(this, Σ_RegExpBenchmark, runBlock9, function () {
                return this.capture({}, { sum: sum });
            });
            var sum = 0;
            for (var i = 0; i < 5; i++) {
        ...
        function runBlock10() {
            var Σ_RegExpBenchmark_runBlock10 = new Σ.Scope(this, Σ_RegExpBenchmark, runBlock10, function () {
                return this.capture({}, { sum: sum });
            });
            var sum = 0;
            for (var i = 0; i < 3; i++) {
        ...
        function runBlock11() {
            var Σ_RegExpBenchmark_runBlock11 = new Σ.Scope(this, Σ_RegExpBenchmark, runBlock11, function () {
                return this.capture({}, { sum: sum });
            });
            var sum = 0;
            for (var i = 0; i < 2; i++) {
        ...
        function run() {
            var Σ_RegExpBenchmark_run = new Σ.Scope(this, Σ_RegExpBenchmark, run, function () {
                return this.capture({}, {});
            });
            for (var i = 0; i < 5; i++) {
                var sum = 0;
